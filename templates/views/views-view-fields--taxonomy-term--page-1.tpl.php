...
<?php 
	...
	$tipo = $fields['field_tipo']->content;
...
<tr class="simple-item">
  ...
  <td class="simple-social">
    <div class="g-plus" data-action="share" data-annotation="bubble" data-height="15" data-href="<?php print $path; ?>"></div>
    <div class="fb-like" data-href="<?php print $path; ?>" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false"></div>
  </td>
</tr>
